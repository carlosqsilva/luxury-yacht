/*
 * backend/resources/configmap/details.go
 *
 * ConfigMap resource handlers, co-located in the per-kind package. Intrinsic
 * fields come from the single model (configmap.Facts).
 */
...
// Service provides detailed ConfigMap views backed by shared dependencies.
type Service struct {
	deps common.Dependencies
}

// NewService constructs a ConfigMap service using the supplied dependencies bundle.
