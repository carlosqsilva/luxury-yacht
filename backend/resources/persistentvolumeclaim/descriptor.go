...
// Descriptor(s) register persistentvolumeclaim's kind(s) in the single kind registry
// (kind/kindregistry.All): the canonical Identity plus the facets every
// subsystem reads. This is the one place persistentvolumeclaim hands itself to the app.
