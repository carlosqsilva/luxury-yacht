...
func appPreferenceDescriptors() []preferenceDescriptor {
	...
	return []preferenceDescriptor{
		...
		boolPreference(appPreferenceSuppressNetworkErrorNotifications, false, false,
			"Suppress network error notifications changed to", func(s *AppSettings) *bool { return &s.SuppressNetworkErrorNotifications }),
		errorReporting,
