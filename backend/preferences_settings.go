...
const (
	...
	appPreferenceSuppressNetworkErrorNotifications        = "suppressNetworkErrorNotifications"
)
...
func (p *PreferencesService) saveAppSettings() error {
	...
	settings.Preferences.SuppressNetworkErrorNotifications = p.appSettings.SuppressNetworkErrorNotifications
