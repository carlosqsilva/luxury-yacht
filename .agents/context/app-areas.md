...
| ---------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| Multi-cluster model          | Cluster identity, selected/background clusters, cluster-scoped cache/store keys, aggregate backend routing | `.agents/skills/cluster-auth-lifecycle/SKILL.md`, `docs/architecture/multi-cluster.md` |
