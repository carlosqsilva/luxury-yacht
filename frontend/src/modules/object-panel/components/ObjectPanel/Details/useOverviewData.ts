  ...
  const workloadOverview = useMemo((): OverviewData | null => {
    ...
    if (podDetails && kind === 'pod') {
      return {
        ...
        statusState: podDetails.statusState,
        statusPresentation: podDetails.statusPresentation,
        statusReason: podDetails.statusReason,
    ...
    if (deploymentDetails && kind === 'deployment') {
      return {
        ...
        statusPresentation: deploymentDetails.statusPresentation,
        statusReason: deploymentDetails.statusReason,
        ...
        podCount: deploymentDetails.podMetricsSummary?.pods,
        readyPodCount: deploymentDetails.podMetricsSummary?.readyPods,
        serviceAccount: deploymentDetails.serviceAccount,
        nodeSelector: deploymentDetails.nodeSelector,
        tolerations: deploymentDetails.tolerations,
    ...
    if (replicaSetDetails && kind === 'replicaset') {
      return {
        ...
        statusPresentation: replicaSetDetails.statusPresentation,
        statusReason: replicaSetDetails.statusReason,
        ...
        podCount: replicaSetDetails.podMetricsSummary?.pods,
        readyPodCount: replicaSetDetails.podMetricsSummary?.readyPods,
    ...
    if (daemonSetDetails && kind === 'daemonset') {
      return {
        ...
        statusPresentation: daemonSetDetails.statusPresentation,
        statusReason: daemonSetDetails.statusReason,
        ...
        podCount: daemonSetDetails.podMetricsSummary?.pods,
        readyPodCount: daemonSetDetails.podMetricsSummary?.readyPods,
    ...
    if (statefulSetDetails && kind === 'statefulset') {
      return {
        ...
        statusPresentation: statefulSetDetails.statusPresentation,
        statusReason: statefulSetDetails.statusReason,
        ...
        podCount: statefulSetDetails.podMetricsSummary?.pods,
        readyPodCount: statefulSetDetails.podMetricsSummary?.readyPods,
        ...
        partition: statefulSetDetails.partition,
        volumeClaimTemplates: statefulSetDetails.volumeClaimTemplates,
        pvcRetentionPolicy: statefulSetDetails.pvcRetentionPolicy,
    ...
    if (jobDetails && kind === 'job') {
      return {
        ...
        statusPresentation: jobDetails.statusPresentation,
        statusReason: jobDetails.statusReason,
    ...
    if (cronJobDetails && kind === 'cronjob') {
      return {
        ...
        statusPresentation: cronJobDetails.statusPresentation,
        statusReason: cronJobDetails.statusReason,
  ...
  const storageOverview = useMemo((): OverviewData | null => {
    ...
    if (pvcDetails && kind === 'persistentvolumeclaim') {
      return {
        ...
        statusPresentation: pvcDetails.statusPresentation,
        statusReason: pvcDetails.statusReason,
    ...
    if (pvDetails && kind === 'persistentvolume') {
      return {
        ...
        statusState: pvDetails.statusState,
        statusPresentation: pvDetails.statusPresentation,
        statusReason: pvDetails.statusReason,
    ...
    if (storageClassDetails && kind === 'storageclass') {
      return {
        ...
        statusReason: storageClassDetails.statusReason,
